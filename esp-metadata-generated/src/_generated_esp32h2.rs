...
macro_rules! property {
    ...
    ("clock_tree.hp_root_clk") => {
        ...
        ::soc::clocks::HpRootClkConfig::Xtal, crate
        ::soc::clocks::HpRootClkConfig::RcFast]
    };
    ...
    ("clock_tree.crypto_clk") => {
        ...
        ::soc::clocks::CryptoClkConfig::PllF64m, crate
        ::soc::clocks::CryptoClkConfig::PllF96m]
    };
    ...
    ("clock_tree.rmt.sclk") => {
        ...
        ::soc::clocks::RmtSclkConfig::RcFastClk]
    };
    ...
    ("clock_tree.mcpwm.function_clock") => {
        [crate ::soc::clocks::McpwmFunctionClockConfig::PllF96m, crate
    ...
    ("clock_tree.i2s.tx_clk.sclk") => {
        ...
        crate ::soc::clocks::I2sClkSclk::PllF64m]
    };
...
macro_rules! define_clock_tree_types {
    () => {
        ...
        pub fn request_pll_f64m_clk(clocks: &mut ClockTree) {
            ...
            if increment_reference_count(&mut clocks.pll_f64m_clk_refcount) {
        ...
        pub fn release_pll_f64m_clk(clocks: &mut ClockTree) {
            ...
            if decrement_reference_count(&mut clocks.pll_f64m_clk_refcount) {
        ...
        pub fn configure_crypto_clk(clocks: &mut ClockTree, new_selector: CryptoClkConfig) {
            ...
            if clocks.crypto_clk_refcount > 0 {
                match new_selector {
                    ...
                    CryptoClkConfig::PllF64m => request_pll_f64m_clk(clocks),
                    CryptoClkConfig::PllF96m => request_pll_f96m_clk(clocks),
                }
                ...
                if let Some(old_selector) = old_selector {
                    match old_selector {
                        ...
                        CryptoClkConfig::PllF64m => release_pll_f64m_clk(clocks),
                        CryptoClkConfig::PllF96m => release_pll_f96m_clk(clocks),
                    }
                }
            } else {
                configure_crypto_clk_impl(clocks, old_selector, new_selector);
        ...
        pub fn crypto_clk_config_frequency(clocks: &mut ClockTree, config: CryptoClkConfig) -> u32 {
            match config {
                ...
                CryptoClkConfig::PllF64m => pll_f64m_clk_frequency(),
                CryptoClkConfig::PllF96m => pll_f96m_clk_frequency(),
            }
        }
        ...
        impl I2sInstance {
            pub fn configure_tx_clk(self, clocks: &mut ClockTree, config: I2sClkConfig) {
                ...
                if clocks.i2s_tx_clk_refcount[self as usize] > 0 {
                    match config.sclk {
                        ...
                        I2sClkSclk::PllF64m => request_pll_f64m_clk(clocks),
                    }
                    ...
                    if let Some(old_config) = old_config {
                        match old_config.sclk {
                            ...
                            I2sClkSclk::PllF64m => release_pll_f64m_clk(clocks),
                        }
                    }
                } else {
                    self.configure_tx_clk_impl(clocks, old_config, config);
            ...
            pub fn tx_clk_config_frequency(clocks: &mut ClockTree, config: I2sClkConfig) -> u32 {
                (((match config.sclk {
                    ...
                    I2sClkSclk::PllF64m => pll_f64m_clk_frequency(),
                } as u64)
                    * (config.div_a() as u64))
...
macro_rules! for_each_analog_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_analog_function!((USJ_DM, GPIO26));
        _for_each_inner_analog_function!((USJ_DP, GPIO27));
        ...
        GPIO11), (XTAL_32K_P, GPIO13), (XTAL_32K_N, GPIO14), (USJ_DM, GPIO26), (USJ_DP,
        GPIO27))); _for_each_inner_analog_function!((ADCn_CHm((ADC1_CH0, ADCn_CHm, 1, 0),
        GPIO1), ((ADC1_CH1, ADCn_CHm, 1, 1), GPIO2), ((ADC1_CH2, ADCn_CHm, 1, 2), GPIO3),
        ((ADC1_CH3, ADCn_CHm, 1, 3), GPIO4), ((ADC1_CH4, ADCn_CHm, 1, 4), GPIO5)));
        _for_each_inner_analog_function!((ZCDn((ZCD0, ZCDn, 0), GPIO10), ((ZCD1, ZCDn,
        1), GPIO11)));
    };
}
...
macro_rules! for_each_lp_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        => {} } _for_each_inner_lp_function!((LP_GPIO0, GPIO7, _0));
        _for_each_inner_lp_function!((LP_GPIO1, GPIO8, _0));
        _for_each_inner_lp_function!((LP_GPIO2, GPIO9, _0));
        _for_each_inner_lp_function!((LP_GPIO3, GPIO10, _0));
        _for_each_inner_lp_function!((LP_GPIO4, GPIO11, _0));
        _for_each_inner_lp_function!((LP_GPIO5, GPIO12, _0));
        _for_each_inner_lp_function!((LP_GPIO6, GPIO13, _0));
        _for_each_inner_lp_function!((LP_GPIO7, GPIO14, _0));
        _for_each_inner_lp_function!(((LP_GPIO0, LP_GPIOn, 0), GPIO7, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO1, LP_GPIOn, 1), GPIO8, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO2, LP_GPIOn, 2), GPIO9, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO3, LP_GPIOn, 3), GPIO10, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO4, LP_GPIOn, 4), GPIO11, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO5, LP_GPIOn, 5), GPIO12, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO6, LP_GPIOn, 6), GPIO13, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO7, LP_GPIOn, 7), GPIO14, _0, () ()));
        _for_each_inner_lp_function!((all(LP_GPIO0, GPIO7, _0), (LP_GPIO1, GPIO8, _0),
        (LP_GPIO2, GPIO9, _0), (LP_GPIO3, GPIO10, _0), (LP_GPIO4, GPIO11, _0), (LP_GPIO5,
        GPIO12, _0), (LP_GPIO6, GPIO13, _0), (LP_GPIO7, GPIO14, _0)));
        _for_each_inner_lp_function!((LP_GPIOn((LP_GPIO0, LP_GPIOn, 0), GPIO7, _0, ()
        ()), ((LP_GPIO1, LP_GPIOn, 1), GPIO8, _0, () ()), ((LP_GPIO2, LP_GPIOn, 2),
        GPIO9, _0, () ()), ((LP_GPIO3, LP_GPIOn, 3), GPIO10, _0, () ()), ((LP_GPIO4,
        LP_GPIOn, 4), GPIO11, _0, () ()), ((LP_GPIO5, LP_GPIOn, 5), GPIO12, _0, () ()),
        ((LP_GPIO6, LP_GPIOn, 6), GPIO13, _0, () ()), ((LP_GPIO7, LP_GPIOn, 7), GPIO14,
        _0, () ())));
    };
}
...
macro_rules! for_each_iomux_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _2))); _for_each_inner_iomux_function!((FSPICSn((FSPICS0, FSPICSn, 0), GPIO1,
